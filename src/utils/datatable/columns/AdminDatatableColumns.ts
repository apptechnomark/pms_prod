...
const adminDashboardReportCols = [
  ...
  { header: "InProgress", label: "In Preparation" },
  { header: "Stop", label: "Preparation Completed" },
  { header: "Submitted", label: "Submitted" },
  { header: "Errorlogs", label: "Errorlogs" },
  { header: "InReview", label: "In Review" },
  { header: "Accept", label: "Review Completed" },
  { header: "AcceptWithNotes", label: "Review Completed [AWN]" },
  { header: "Rework", label: "Rework" },
  { header: "ReworkInProgress", label: "Rework In Preparation" },
  ...
  { header: "ReworkAccept", label: "Rework Review Completed" },
  { header: "ReworkAcceptWithNotes", label: "Rework Review Completed [AWN]" },
